...
class MatchJob(Base):
    ...
    client_session_key: Mapped[str | None] = mapped_column(String(120), nullable=True)
    client_machine_fingerprint: Mapped[str | None] = mapped_column(String(120), nullable=True)
    ...
    client_cpu_name: Mapped[str | None] = mapped_column(String(200), nullable=True)
    client_ram_total_mb: Mapped[int | None] = mapped_column(Integer, nullable=True)
    client_ram_speed_mt_s: Mapped[int | None] = mapped_column(Integer, nullable=True)
